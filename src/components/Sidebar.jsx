...
import AssignStructure from "./hr/setuppayroll/AssignStructure";
import CreateStructure from "./hr/setuppayroll/CreateStructure"
import PayrollSettings from "./hr/setuppayroll/payrollSettings";
  ...
  return (
    <div className="relative h-auto bg-[#0098f1]  bg-opacity-10">
      ...
      >
        ...
        {activeTab === "Assign Structure" && <AssignStructure />}

        {activeTab === "Create Structure" && <CreateStructure />}
