...
const EmployeeSideBar = () => {
  ...
  const options = [
    ...
    { title: "Activities", icon: <FaTasks /> },
    {
      ...
      subOptions: [
        ...
        { name: "Payroll Summary", icon: <GiChart /> },
        { name: "Payroll settings", icon: <GiChart /> },
        { name: "Advances/loans", icon: <GiChart /> },
        { name: "Payslips", icon: <GiChart /> },
        { name: "Settlements", icon: <GiChart /> },
        { name: "Payroll Forms", icon: <GiChart /> },
        { name: "Direct deposits", icon: <GiChart /> },
        { name: "YTD important", icon: <GiChart /> },
        { name: "Gratuity Calculator", icon: <GiPayMoney /> },
        { name: "Estimated tax sheet", icon: <GiChart /> },
      ],
    },
  ...
  return (
    <div className="relative bg-[#e65f2b] h-screen bg-opacity-10">
      <EmployeeNavBar />
      <div
        className={`flex ${
